<?php
  $BDProductos = array( 
    ...
    array("Blusa", "Lentes", "Playera", "Pantalón", "Vestido","Chaqueta","Abrigo"), //La Descripción
    array(100, 350, 200, 420, 250, 600, 400),                             //El Precio
  ...
  $BDAlmacen = array( 
    ...
    array(0, 10, 5, 15, 3, 2, 3)); //Las Existencias
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52 618 3641 776</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> sopasasadas@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
